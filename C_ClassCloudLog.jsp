      ...
      <div class="mainbar">
        <div class="article">
          ...
          <table width="559" border="0">
            <tr>
              <td width="99" height="36" bgcolor="#FFFF00"><div align="center" class="style30">1</div></td>
              <td width="442" bgcolor="#FFFF00"><div align="center" class="style30"><a href="C_Transactions.jsp">View Generation PPL Based On File Operations </a> </div></td>
            </tr>
            <tr>
              <td height="43" bgcolor="#FFFF00"><div align="center" class="style30">2</div></td>
              <td bgcolor="#FFFF00"><div align="center" class="style30"><a href="C_Transactions1.jsp">View Generation PPL Based OnSearch Keyword Operations</a> </div></td>
            </tr>
            <tr>
              <td height="20">&nbsp;</td>
              <td>&nbsp;</td>
