...
%>
            ...
            <table width="491" border="0" style="border-collapse:collapse" cellpadding="0" cellspacing="0" align="center">
              <tr>
                <td width="113" height="35"><span class="odd style13 style29 style32"><strong>File Name : </strong> </span></td>
                <td width="432"><input name="t42" type="text" id="t42" size="49" value="<%= file %>" readonly="readonly" /></td>
              </tr>
              <tr>
                <td height="35"><span class="odd style13 style29 style32"><strong>Index : </strong> </span></td>
              ...
              <tr>
                <td height="35"><span class="odd style13 style29 style32"><strong>HMAC  : </strong></span></td>
