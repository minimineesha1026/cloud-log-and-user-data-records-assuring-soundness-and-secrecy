...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span>Top K Documents  </span></h2>
          <p>&nbsp;</p>
          <p>&nbsp;</p>
...
try 
	{		
				%>
            <tr>
              <td width="51" height="30"><div align="center" class="style25"> ID </div></td>
              <td width="144"><div align="center" class="style25">File Name </div></td>
              <td width="140"><div align="center" class="style25">Rank  </div></td>
              <td width="152"><div align="center" class="style25">Data Owner </div></td>
            </tr>
            <%
