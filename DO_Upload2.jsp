...
//				System.out.println("PUBLIC KEY" + pub);
				...
				String dname1 = new String(Base64.encode(dname.getBytes()));
				String fname1 = new String(Base64.encode(file.getBytes()));
				String task1 = new String(Base64.encode(task.getBytes()));
				String dt11 = new String(Base64.encode(dt.getBytes()));
				
				String strQuery2 = "insert into cloudlog(user,fname,task,dt) values('"+dname1+"','"+fname1+"','"+task1+"','"+dt11+"')";
				st.executeUpdate(strQuery2);
				
				String No="No";
st.executeUpdate("insert into  cloudserver(fname,ct,findex,trapdoor,sk,rank,dt,downer) values ('"+file+"','"+cont+"','"+index+"','"+mac+"','"+pk+"','"+rank+"','"+dt1+"','"+dname+"')"); 
