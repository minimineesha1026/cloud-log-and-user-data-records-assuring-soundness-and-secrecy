...
%>
            ...
            <table width="522" border="0" style="border-collapse:collapse" cellpadding="0" cellspacing="0" align="center">
              <tr>
                <td width="143" height="35"><span class="style18"><strong>Enter File Name :</strong></span></td>
              ...
              <tr>
                <td height="41"><span class="style18"><strong>HMAC :</strong></span></td>
                <td><input name="t12" type="text" value="<%=trapdoor%>" size="40" /></td>
              </tr>
              <tr>
                <td height="40"><span class="style18"><strong>Secret Key :</strong></span></td>
            ...
            <h3 class="style23">File Doesn't Exist !!!</h3>
            <p>
              <%
					}
