      ...
      <div class="mainbar">
        <div class="article">
          ...
          <table width="500" border="1.5" cellpadding="0" cellspacing="0"  align="center">
            <tr>
              <td width="108" height="30" bgcolor="#FF0000"><div align="center" class="style21 style24"><strong>Owner ID </strong></div></td>
              <td width="183" bgcolor="#FF0000"><div align="center" class="style26">Owner Name </div></td>
