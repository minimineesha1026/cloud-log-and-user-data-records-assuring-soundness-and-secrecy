        ...
        <div class="article">
          ...
          <form id="form1" name="form1" method="post" action="DO_Upload1.jsp">
            <table width="491" height="433" border="0" align="center" cellpadding="0"  cellspacing="0" style="border-collapse:collapse">
              <tr>
                <td width="133" height="35"><span class="odd style14 style28"><span class="odd style11 style16 style30"> Select File :</span></span></td>
              ...
              <tr>
                <td height="35" class="odd style14 style28"><span class="odd style11 style16 style30">File Name :</span> </td>
