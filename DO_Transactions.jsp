	...
	try 
	{
		...
		while ( rs1.next() )
		{
			...
			while ( rs.next() )
			{
				...
				<td bgcolor="#FF00FF"><div align="center" class="style28"><%=s3%></div></td>
				<td bgcolor="#FF00FF"><div align="center" class="style28"><%=s4%></div></td>
				<td bgcolor="#FF00FF"><div align="center" class="style28"><%=s5%></div></td>
				<td bgcolor="#FF00FF"><div align="center" class="style28"><%=s6%></div></td>
				</tr>
				<%
			}
		}
...
%>
          ...
          <p>&nbsp;</p>
          <p align="center"><a href="DO_Transactions1.jsp" class="style29">Decrypt and View </a></p>
