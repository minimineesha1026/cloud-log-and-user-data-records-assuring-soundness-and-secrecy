      ...
      <div class="mainbar">
        <div class="article">
          ...
          <table width="500" border="1.5" cellpadding="0" cellspacing="0"  align="center">
            <tr>
              <td width="108" height="30" bgcolor="#FF0000"><div align="center" class="style21 style27"><strong>User ID </strong></div></td>
              <td width="183" bgcolor="#FF0000"><div align="center" class="style28">Users Name </div></td>
