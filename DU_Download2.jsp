    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
				...
				if(rs2.next()==true)
							{
								...
								String s22 = new String(Base64.encode(file.getBytes()));
								String task1 = new String(Base64.encode(task.getBytes()));
								String dt1 = new String(Base64.encode(dt.getBytes()));
										
										
										String Query2 = "insert into cloudlog(user,fname,task,dt) values('"+user1+"','"+s22+"','"+task1+"','"+dt1+"')";
          ...
          <h3 class="style23">Trapdoor Mismatch !!</h3>
