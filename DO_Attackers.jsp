...
.style27 {font-size: 14px; font-weight: bold; color: #FFFF00; }
-->
</style>
</head>
<body>
      ...
      <div class="mainbar">
        <div class="article">
          ...
          <table width="615" border="1.5" cellpadding="0" cellspacing="0" align="center">
            <tr>
              <td width="37" height="31" bgcolor="#FF0000"><div align="center" class="style22 style26"> ID </div></td>
              <td width="76" bgcolor="#FF0000"><div align="center" class="style27"> Name </div></td>
              <td width="97" bgcolor="#FF0000"><div align="center" class="style27">File Name </div></td>
              <td width="131" bgcolor="#FF0000"><div align="center" class="style27">Missmatch Key </div></td>
              <td width="122" bgcolor="#FF0000"><div align="center" class="style27">Date &amp; Time</div></td>
              <td width="138" bgcolor="#FF0000"><div align="center" class="style27">Attack Type </div></td>
            </tr>
            <%
