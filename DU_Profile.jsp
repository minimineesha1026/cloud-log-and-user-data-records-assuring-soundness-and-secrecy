      ...
      <div class="mainbar">
        <div class="article">
          ...
          <table width="546" height="311" border="2" align="center"  cellpadding="0" cellspacing="0"  style="border-collapse: collapse; ">
            ...
            <tr>
              <td  width="150" valign="middle" height="40" style="color: #2c83b0;"><div align="left" class="style2" style="margin-left:20px;">
                <div align="left">Username</div>
              </div></td>
              <td  width="300" valign="middle" height="40" style="color:#000000;"><div align="left" class="style3" style="margin-left:20px;">
                  <%out.println(s1);%>
              </div></td>
            </tr>
            <tr>
              <td  width="120" valign="middle" height="40" style="color: #2c83b0;"><div align="left" class="style2" style="margin-left:20px;">
                <div align="left">E-Mail</div>
              </div></td>
              <td  width="72" valign="middle" height="40" style="color:#000000;"><div align="left" class="style3" style="margin-left:20px;">
                  <%out.println(s2);%>
              </div></td>
            </tr>
            <tr>
              <td  width="100" valign="middle" height="40" style="color: #2c83b0;"><div align="left" class="style2" style="margin-left:20px;">
                <div align="left">Mobile</div>
              </div></td>
              <td  width="82" valign="middle" height="40"><div align="left" class="style3" style="margin-left:20px;">
                  <%out.println(s3);%>
              </div></td>
            </tr>
            <tr>
              <td  width="100" align="left" valign="middle" height="40" style="color: #2c83b0;"><div align="left" class="style2" style="margin-left:20px;">
                <div align="left">Date Of Birth</div>
              </div></td>
              <td  width="82" align="left" valign="middle" height="40"><div align="left" class="style3" style="margin-left:20px;">
                  <%out.println(s5);%>
              </div></td>
            </tr>
            <tr>
